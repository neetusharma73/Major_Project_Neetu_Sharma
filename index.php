...
<body>
    ...
    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="pics/dog1.jpg" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
          <img src="pics/dog2.jpg" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
          <img src="pics/dog3.jpg" class="d-block w-100" alt="...">
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container" id="about">
    ...
    <div class="row">
      <div class="col-md-4">
        <img src="pics/dc11.jpg" alt="" style='width:100%'>
      </div>
      <div class="col-md-8">
  ...
  <div class="container" id="padopt">
    <h1 class="text-center m-4" id="heading">Pet's For Adopt</h1>
    <div class="row">

      <?php
         include('Connection.php');

         $sql = 'select * from padopt_db';
       ...
       <div class="col-md-4 mb-3">
        <div class="card" style="width: 18rem;">
          <img src='. $row['pet_image'] .' class="card-img-top" alt="..."
          style="width:100%; height:150px;">
          <div class="card-body">
            <h5 class="card-title">'. $row['pet_breed'].'</h5>
            <p class="card-text">'. substr($row['pet_desc'],0,65)   .'</p>
            <a href="pet_description.php?pet_id='.$id.'" class="btn btn-primary">Read More</a>
          </div>
        </div>
      </div>';
